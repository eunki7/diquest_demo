...
# csv 데이터 로드
data = pd.read_csv('../dataset/calldata_original.csv', encoding='euc-kr')
...
data.to_csv('../dataset/call_preprocessing_20190401.csv', index=False, encoding="euc-kr", mode="w", sep=",")
...
result.to_csv('../dataset/call_result.csv_20190401', index=False, encoding="euc-kr", mode="w", sep=",")
